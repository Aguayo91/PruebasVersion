...
public class ViewQr extends BarcodeScannerView{
    private static final String TAG = "ZXingScannerView";
    private MultiFormatReader mMultiFormatReader;
    public static final List<BarcodeFormat> ALL_FORMATS = new ArrayList();
    private List<BarcodeFormat> mFormats;
    private ViewQr.ResultHandler mResultHandler;

    public ViewQr(Context context) {
        super(context);
        this.initMultiFormatReader();
    }

    public ViewQr(Context context, AttributeSet attributeSet) {
    ...
    public void setResultHandler(ViewQr.ResultHandler resultHandler) {
            ...
            try {
                ...
                if(var22 != null) {
                    ...
                    handler.post(new Runnable() {
                        public void run() {
                            ViewQr.ResultHandler tmpResultHandler = ViewQr.this.mResultHandler;
                            ViewQr.this.mResultHandler = null;
                            ViewQr.this.stopCameraPreview();
                            if(tmpResultHandler != null) {
                                tmpResultHandler.handleResult(var22);
                            }
    ...
    public void resumeCameraPreview(ViewQr.ResultHandler resultHandler) {
        this.mResultHandler = resultHandler;
