...
public class MediaVideoUtilsV2 extends  BaseMediaUtils implements MediaRecorder.OnInfoListener, SurfaceHolder.Callback {

    public MediaVideoUtilsV2(Context context, String fileExt, int duracion) {
