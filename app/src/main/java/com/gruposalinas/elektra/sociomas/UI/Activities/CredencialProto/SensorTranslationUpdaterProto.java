...
public class SensorTranslationUpdaterProto
        implements ParallaxLayerLayoutProto.TranslationUpdater, SensorEventListener {
    ...
    public SensorTranslationUpdaterProto(Context context) {
        this((SensorManager) context.getSystemService(Context.SENSOR_SERVICE));
    }

    public SensorTranslationUpdaterProto(SensorManager sensorManager) {
        this.sensorManager = sensorManager;
    }

    @Override
    public void subscribe(ParallaxLayerLayoutProto parallaxLayerLayout) {
