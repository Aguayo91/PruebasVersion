...
public class FullscreenImageActivity extends BaseCoreCompactActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra(Constants.BITMAP_SELECTED_IMAGE)){
            Bitmap bitmap=getIntent().getParcelableExtra(Constants.BITMAP_SELECTED_IMAGE);
