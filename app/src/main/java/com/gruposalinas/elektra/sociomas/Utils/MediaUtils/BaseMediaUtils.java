...
public abstract class BaseMediaUtils {
    ...
    /*CONSTRUCTOR*/
    public  BaseMediaUtils(Context context, String fileExt, int duracion) {
    ...
    public String getFileNameWS(){
       return  com.sociomas.core.Utils.Utils.getNumeroEmpleado(this.context).concat(dateFormat.format(new Date()));
    }
