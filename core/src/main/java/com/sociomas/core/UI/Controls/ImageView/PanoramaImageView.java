...
public class PanoramaImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public static final byte ORIENTATION_BOTH=2;
    ...
    private float mMxOffsetHorizontal;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getDrawable() != null) {
          ...
          //  if (mDrawableWidth * mHeight > mDrawableHeight * mWidth) {
            ...
            float imgScaleHorizontal = (float) mHeight / (float) mDrawableHeight;
            mMxOffsetHorizontal = Math.abs((mDrawableWidth * imgScaleHorizontal - mWidth) * 0.5f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw image
        if (mOrientation == ORIENTATION_HORIZONTAL) {
            float currentOffsetX = mMxOffsetHorizontal * mProgress;
            canvas.save();
