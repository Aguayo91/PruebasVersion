...
public class SensorTranslationUpdater
    ...
    private static final String TAG = "SensorTranslationUpdate";
    ...
    public void registerSensorManager() {
        if (sensorManager != null) {
            ...
            if (rotationVectorSensor != null) {
                Log.d(TAG, "registerSensorManager:Tiene sensor de giroscopio ");
                sensorManager.registerListener(this, rotationVectorSensor, DEFAULT_SAMPLING_PERIOD);
            }
            else{
                Log.d(TAG, "registerSensorManager:No tiene sensor de giroscopio ");
            }
        }
    }
