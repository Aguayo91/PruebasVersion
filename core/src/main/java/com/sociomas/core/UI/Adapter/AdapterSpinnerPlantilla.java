...
public class AdapterSpinnerPlantilla extends ArrayAdapter<Plantilla> implements SpinnerAdapter{
    ...
    public AdapterSpinnerPlantilla(@NonNull Context context, @LayoutRes int resource, @NonNull List<Plantilla> items) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imgUserAvatar = (ImageView)convertView.findViewById(R.id.imgUserAvatar);
        ...
        tvUserId.setText(getContext().getString(R.string.idEmpleado).concat( Utils.toTitleCase(this.getItem(position).getIdEmpleado())));
        return convertView;
    }
