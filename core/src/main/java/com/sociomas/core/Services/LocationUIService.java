package com.sociomas.core.Services;
...
public class LocationUIService extends Service implements
    ...
    private static final String TAG = "LocationUIService";
    ...
    private void onLocationChangedListener(Location location){
        ...
        intentBroadCast.putExtra(Constants.CURRENT_ACCURACY,location.getAccuracy());
        intentBroadCast.putExtra(Constants.CURRENT_LATLONG,new double[]{location.getLatitude(),location.getLongitude()});
